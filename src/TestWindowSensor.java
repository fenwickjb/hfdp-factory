...
public class TestWindowSensor {

    static WindowSensor s;  
    ...
    @Test
    void testArm() {
	String expectedOutput = "meWindow is armed.\n";
	...
	String expectedOutput = "meWindow is disarmed.\n";
